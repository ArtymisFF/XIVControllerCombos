...
{
    class XIVControllerCombos : IDalamudPlugin
    {
        public string Name => "XIV Controller Combo";
        ...
        public XIVControllerCombos(IClientState clientState, ICommandManager commandManager, IDataManager manager, IDalamudPluginInterface pluginInterface, ISigScanner sigScanner, IJobGauges jobGauges, IChatGui chatGui, IGameInteropProvider gameInteropProvider, IPluginLog pluginLog)
        {
